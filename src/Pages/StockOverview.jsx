...
import { Plus, AlertTriangle } from 'lucide-react'; // ⚠️ warning icon
        ...
        {items.map(item => {
          ...
          return (
            <div
              ...
              className={`bg-white shadow-md rounded-lg p-4 text-center cursor-pointer border border-gray-100 transition-all hover:shadow-lg
